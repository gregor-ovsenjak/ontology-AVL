...
with open(r"C:\Users\grego\Desktop\New folder\avl-VCD\video-content-description-VCD-master\ontologies\AGO\etc\neo4j.json") as config_file:
...
class Neo4jScenarioDB:
    ...
    def add_property(labels, node_identifier, identifier_value, properties):
        ...
        for prop in properties:
            ...
            with session:
                if prop_type == str:
                    session.run(""" MATCH (node:"""+cypher_labels[1:]+""") 
    ...
    def create_scenario(scenario_uid: str, vcd: core.VCD = None, only_static=True):
        ...
        with session:
            ...
            #Neo4jScenarioDB.clear_database()
                ...
                if vcd.has_elements(element_type):
                    ...
                    for element_uid in element_uids:
                        ...
                        if 'ontology_uid' in element:
                            ...
                            #Neo4jScenarioDB.add_property([scenario_uid, element_type.name], 'uid', element_uid, ontology_uid)
                        if 'frame_intervals' in element:
                            print(element["frame_intervals"])
